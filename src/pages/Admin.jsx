...
const CheckAdminContext = createContext();
...
function Admin() {
  ...
  return (
    <>
      {toAdmin === false ? (
        <CheckAdminContext.Provider value={{ toAdmin, setToAdmin }}>
          <Check></Check>
